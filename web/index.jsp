<%-- 
    Document   : index
    Created on : 24/08/2018, 11:43:42 AM
    Author     : Labing I5
--%>
...
<div class="container-fluid">
		...
		<div class="col-sm-6">
			...
			<div class="alert alert-success alert-dismissible" role="alert">
				...
				<strong>Eror:</strong> Debe ingresar el nombre y el apellido!
			</div>	
                    <%
                       }
                    %>
                ...
                <%
                    ...
                    %>
                      <tr>
                        ...
                        <td><a href="RegistroServlet?editar=<%=persona.getId()%>">Editar</a></td>
                        <td><a href="RegistroServlet?borrar=<%=persona.getId()%>">Borrar</a></td>
                     </tr>
                    <%
                        }
                    }
